  ...
  return (
    <Jumbotron style={{minHeight: '100%', overflow: 'auto'}} fluid>
      <Container style={{minWidth: '100%'}}>
        ...
        <hr></hr>
        <h2 style={{float: "left", maxWidth: "50%", display: "inline", marginTop: '1rem', fontSize: '3vw'}}>Full Stack Developer</h2>
        <p style={{float: "left", maxWidth: "40%", display: "inline", marginTop: '2rem', fontSize: '1.75vw'}}>
